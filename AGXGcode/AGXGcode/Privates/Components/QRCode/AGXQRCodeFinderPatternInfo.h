...
#ifndef AGXGcode_AGXQRCodeFinderPatternInfo_h
#define AGXGcode_AGXQRCodeFinderPatternInfo_h

#import "AGXQRCodeFinderPattern.h"

@interface AGXQRCodeFinderPatternInfo : NSObject
@property (nonatomic, readonly) AGXQRCodeFinderPattern *bottomLeft;
...
#endif /* AGXGcode_AGXQRCodeFinderPatternInfo_h */
