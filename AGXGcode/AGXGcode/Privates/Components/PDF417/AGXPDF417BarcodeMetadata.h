...
#ifndef AGXGcode_AGXPDF417BarcodeMetadata_h
#define AGXGcode_AGXPDF417BarcodeMetadata_h

#import <AGXCore/AGXCore/AGXObjC.h>

@interface AGXPDF417BarcodeMetadata : NSObject
@property (nonatomic, readonly) int columnCount;
@property (nonatomic, readonly) int errorCorrectionLevel;
@property (nonatomic, readonly) int rowCountUpperPart;
...
#endif /* AGXGcode_AGXPDF417BarcodeMetadata_h */
