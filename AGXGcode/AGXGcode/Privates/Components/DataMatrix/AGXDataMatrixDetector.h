...
#ifndef AGXGcode_AGXDataMatrixDetector_h
#define AGXGcode_AGXDataMatrixDetector_h

#import "AGXDetectorResult.h"

@interface AGXDataMatrixDetector : NSObject
+ (AGX_INSTANCETYPE)detectorWithBits:(AGXBitMatrix *)bits error:(NSError **)error;
- (AGXDetectorResult *)detectWithError:(NSError **)error;
@end

#endif /* AGXGcode_AGXDataMatrixDetector_h */
