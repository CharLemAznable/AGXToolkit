 ...
 */
+ (int)decodeAsciiSegment:(AGXBitSource *)bits result:(NSMutableString *)result resultTrailer:(NSMutableString *)resultTrailer {
    BOOL upperShift = NO;
    do {
        ...
        if (oneByte == 0) {
            ...
            if (upperShift) oneByte += 128; //upperShift = NO;
            ...
            if (value < 10) [result appendString:@"0"]; // pad with '0' for single digit values
            ...
            if (oneByte != 254 || bits.available != 0) return -1;
        }
 ...
 */
+ (BOOL)decodeC40Segment:(AGXBitSource *)bits result:(NSMutableString *)result {
 ...
 */
+ (BOOL)decodeTextSegment:(AGXBitSource *)bits result:(NSMutableString *)result {
 ...
 */
+ (BOOL)decodeAnsiX12Segment:(AGXBitSource *)bits result:(NSMutableString *)result {
 ...
 */
+ (void)decodeEdifactSegment:(AGXBitSource *)bits result:(NSMutableString *)result {
    do {
 ...
 */
+ (BOOL)decodeBase256Segment:(AGXBitSource *)bits result:(NSMutableString *)result byteSegments:(NSMutableArray *)byteSegments {
    ...
    [result appendString:[NSString stringWithBytes:bytes.array length:bytes.length encoding:NSISOLatin1StringEncoding]];
    return YES;
}
