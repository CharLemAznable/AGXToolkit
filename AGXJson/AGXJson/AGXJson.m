...
+ (NSValue *)valueWithValidJsonObject:(id)jsonObject {
    ...
    PerformSelectorWrapper(return [self performSelector:jsonSel withObject:jsonObject];)
}
...
- (id)validJsonObjectWithOptions:(AGXJsonOptions)options {
    ...
    PerformSelectorWrapper([result addEntriesFromDictionary:[self performSelector:jsonSel]];)
