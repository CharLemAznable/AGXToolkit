...
- (void)testNSDictionaryAGXCore {
    ...
    XCTAssertEqualObjects(dict.objectForKey(nilObject)?:@"bbb", @"bbb");
    ...
    XCTAssertEqualObjects(dictMutableDeepCopy.objectForKey(@"AAA")?:@"bbb", @"bbb");
    ((NSMutableDictionary *)dictMutableDeepCopy)[@"BBB"] = nilObject;
    XCTAssertNil(dictMutableDeepCopy[@"BBB"]);
    XCTAssertEqualObjects(dictMutableDeepCopy.objectForKey(@"BBB")?:@"ccc", @"ccc");
    [((NSMutableDictionary *)dictMutableDeepCopy) removeObjectForKey:@"CCC"];
    XCTAssertNil(dictMutableDeepCopy[@"CCC"]);
    XCTAssertEqualObjects(dictMutableDeepCopy.objectForKey(@"CCC")?:@"ddd", @"ddd");
...
- (void)testNSDictionaryAGXCoreSafe {
    ...
    XCTAssertEqualObjects(dictMutable.objectForKey(nilStr)?:@"bbb", @"bbb");
    ...
    XCTAssertEqualObjects(dictMutable.objectForKey(NSNull.null)?:@"bbb", @"nil");
    ...
    XCTAssertEqualObjects(dictMutable.objectForKey(@"nil")?:@"bbb", @"bbb");
    ...
    XCTAssertNotNil([dictMutable objectForKey:NSNull.null]);
    XCTAssertNotNil(dictMutable[NSNull.null]);
    XCTAssertEqualObjects(dictMutable.objectForKey(NSNull.null)?:@"bbb", @"ccc");
    ...
    XCTAssertEqualObjects(dictMutable.objectForKey(@"BBB")?:@"ccc", @"ccc");
    ...
    XCTAssertEqualObjects(dictMutable.objectForKey(@"CCC")?:@"ddd", @"ddd");
    ...
    XCTAssertEqualObjects(dictMutable.objectForKey(@"AAA")?:@"bbb", @"bbb");
